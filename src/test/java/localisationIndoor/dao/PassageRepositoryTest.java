...
public class PassageRepositoryTest {
    ...
    public void recupererNbPersonneParSalle() {
        ...
        assertEquals(2, p1.getNbPersonneDansChaqueSalle(1));
        assertEquals(2, p2.getNbPersonneDansChaqueSalle(2));
        assertEquals(3, p3.getNbPersonneDansChaqueSalle(3));
        assertEquals(3, p4.getNbPersonneDansChaqueSalle(3));
    }
}
