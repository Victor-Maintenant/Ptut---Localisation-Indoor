...
var isRdc = true;
var rdc = document.getElementById('plan').innerHTML;
var etage = '<div id="etage">\n' +
    '    <img src="../static/images/isisetage.png" usemap="#image-map-etage" class="carte">\n' +
    '\n' +
...
document.getElementById('btnEtage').onclick = function(){
    if (isRdc== true){
        ...
        document.getElementById("plan").innerHTML=rdc;
